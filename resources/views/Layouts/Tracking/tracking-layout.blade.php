...
<head>
    ...
    <link rel="icon" type="image/png" sizes="32x32" href="{{$waybill_hd->company->company_logo}}">
    <!-- Favicon -->
...
<!-- Footer -->
@include('Includes.Tracking.footer')
...
<script>
    ...
    (function () {
        var options = {
            whatsapp: "+966" + '{{substr($waybill_hd->company->co_mobile_number,1)}}', // WhatsApp number
