            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('PriceList.update',$price_list->price_list_id) }}" method="post">
                                @csrf
                                @method('put')
                                <div class="row">
                                    <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <label>@lang('customer.shipe_type')</label>
                                                    <select class="form-control" v-model="waybill_item">
                                                ...
                                                <div class="col-md-3">
                                                    <label>@lang('trucks.car_loc_from')</label>
                                                    <select class="form-control type" v-model="waybill_loc_from">
                                                        <option value="">@lang('home.choose')</option>
                                                ...
                                                <div class="col-md-3">
                                                    <label>@lang('trucks.car_loc_to')</label>
                                                    <select class="form-control type" v-model="waybill_loc_to">
                                                        <option value="">@lang('home.choose')</option>
                                                        @foreach($sys_codes_location as $sys_code_location)
                                                            <option value="{{ $sys_code_location->system_code_id }}">
                                                                @if(app()->getLocale()=='ar')
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <a href="{{route('PriceList.duplicate',$price_list->price_list_id)}}"
                                                       class="btn btn-primary mt-2 form-control type" id="create_inv">
                                                        @lang('home.duplicate')</a>
                                    ...
                                    <div class="col-md-12">
                                        <table class="table table-bordered table-condensed" id="add_table">
                                            ...
                                            <tr id="add_clone" class="clone"
                                                ...
                                                <td>
                                                    <input type="decimal"
                                                           ...
                                                           name="old_distance[]" value="0.00" required>
                                                </td>
                                            ...
                                            <tr id="add_clone" class="clone" v-for="(price_list,index) in priceLists">
                                                ...
                                                <td class="text-center">
                                                    <input type="number"
                                                           v-model="priceLists[index]['max_fees']" step="0.0001"
                                                ...
                                                <td class="text-center">
                                                    <input type="number"
                                                           v-model="priceLists[index]['min_fees']" step=".0001"
