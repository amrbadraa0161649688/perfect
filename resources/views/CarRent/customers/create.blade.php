                            ...
                            <div class="mb-3">
                                <div class="row">
                                    ...
                                    <div class="col-md-3 form-group">
                                        ...
                                        <select
                                            class="selectpicker form-control @error('id_type_code') is-invalid @enderror"
                                            name="id_type_code" id="id_type_code" data-live-search="true"
                                    ...
                                    <div class="col-md-3 form-group">
                                        <label class="col-form-label">@lang('home.customer_type')<span
                                                class="text-danger">*</span></label>
                                        <select
                                            class="selectpicker form-control @error('customer_type') is-invalid @enderror"
                                            name="customer_type" data-live-search="true" required readonly>
                                    ...
                                    <div class="col-md-3 form-group">
                                        ...
                                        <select
                                            ...
                                            name="customer_classification" required readonly data-live-search="true">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 form-group">
                                        <label for="recipient"
                                               class="col-form-label"> @lang('home.customer_address_home') <span
                                                class="text-danger"></span></label>
                                        <input type="text"
                                               class="form-control @error('customer_address_1') @enderror"
                                    ...
                                    <div class="col-md-4 form-group">
                                        <label for="recipient-name"
                                               class="col-form-label"> @lang('home.phone_home') <span
                                                class="text-danger"></span></label>
                                        <input type="number"
                                               class="form-control @error('customer_phone_home')  @enderror"
                                               name="customer_phone_home"
                                               id="customer_phone_home" autocomplete="off"
                                               placeholder="@lang('home.phone_home')" >
                                    ...
                                    <div class="col-md-4 form-group">
                                        ...
                                        <input type="text"
                                               class="form-control @error('customer_job') @enderror"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 form-group">
                                        <label for="recipient"
                                               class="col-form-label"> @lang('home.customer_address_job') <span
                                                class="text-danger"></span></label>
                                        <input type="text"
                                               class="form-control @error('customer_address_2') @enderror"
                                    ...
                                    <div class="col-md-4 form-group">
                                        ...
                                        <input type="number"
                                               class="form-control @error('customer_phone')@enderror"
                                               name="customer_phone"
                                               autocomplete="off"
                                    ...
                                    <div class="col-md-4 form-group">
                                        ...
                                        <input type="text"
                                               class="form-control @error('customer_company')  @enderror"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 form-group">
                                        ...
                                        <input type="email"
                                               class="form-control @error('customer_email') @enderror"
                                               name="customer_email"
