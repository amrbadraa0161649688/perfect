                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" class="form-control" value="@if($customer->cus_type){{app()->getLocale() == 'ar'
                                         ...
                                         : $customer->cus_type->system_code_name_en}}@else @endif" readonly>
                                    </div>

                                    {{--تصنيف العميل--}}
                                    <div class="col-md-3">
                                        <label class="col-form-label">@lang('home.customer_classification')</label>
                                        {{--<select class="form-control" name="customer_classification">--}}
                                        ...
                                        <input type="text" class="form-control" value="@if($customer->classifications){{app()->getLocale() == 'ar'
                                         ...
                                         : $customer->classifications->system_code_name_en}}@else @endif" readonly>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        {{--<select class="form-control" name="id_type_code">--}}
                                        ...
                                        <input type="text" class="form-control" value="@if($customer->TypeCode){{app()->getLocale() == 'ar'
                                         ...
                                         : $customer->TypeCode->system_code_name_en}}@else @endif" readonly>
                                    </div>
...
{{--                                               v-model="customer_birthday"--}}
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="date" class="form-control " name="customer_birthday_hijiri"
{{--                                               v-model="customer_birthday_hijiri"--}}
                                               value="{{$customer->customer_birthday_hijiri}}"
                                               readonly>
                                    </div>
                                    {{--السن--}}
                                    <div class="col-md-3">
                                        ...
                                        <input type="number" class="form-control"
                                               disabled="" readonly value="{{$customer->age}}">
                                    </div>
                                    {{--نسبه الضريبه--}}
                                    <div class="col-md-3">
                                        <label for="recipient"
                                ...
                                <div class="row">
                                    ...
                                    {{--required>--}}
                                    {{--@foreach($sys_codes_status as $sys_code_status_a) فعال72--}}
                                    ...
                                    <div hidden class="col-md-4">
                                        ...
                                        <select class="selectpicker form-select form-control" name="customer_ref_no"
                                                id="customer_mobile_code" required data-live-search="true">
                            ...
                            <x-files.form required="0">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select class="selectpicker form-control" name="attachment_type" data-live-search="true" required>
                ...
                <div class="card-footer">
                    @if(session('redirect_path'))
                        <a href="{{route(session('redirect_path')).'?customer_id='.$customer->customer_id}}" class="btn btn-primary mr-2"
