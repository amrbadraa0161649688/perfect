...
@section('content')
    ...
    <div class="container mt-5" id="app">
        <div class="row d-flex justify-content-center align-items-center">
            <div class="col-md-12">
                <form id="regForm" action="{{route('car-rent.store')}}" method="post">
                    @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="selectpicker"
                                                    ...
                                                    v-on:change="getCustomer(); getPriceList() ;getCars()"
                                                    required>
                                    ...
                                    <div class="col-sm-3 col-md-3">
                                        <div class="form-group">
                                            ...
                                            <a class="btn btn-primary mt-4"
                                               ...
                                               style="color:#ffffff">@lang('home.add_customer')</a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-0">
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <label class="form-label">@lang('home.is_this_additional_driver')</label>
                                                </div>

                                                <div class="col-md-1">
                                                    <label class="form-label">@lang('home.yes')</label>
                                                    <input type="radio" name="additional_driver"
                                                           id="additional_driver_yes"
                                        ...
                                        <div class="form-group mb-0">
                                            <div class="row">
                                                <div class="col-md-4">{{--هل االموفوض هو نفسه المستأجر--}}
                                                    <label class="form-label">@lang('home.is_the_commissioner_the_same_as_the_lessee')</label>
                                                </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="selectpicker"
                                                ...
                                                @foreach($customers as $driver)
                                                    <option value="{{$driver->customer_id}}">{{app()->getLocale() == 'ar'
                                                                    ? $driver->customer_name_full_ar
                                                                    : $driver->customer_name_full_en }}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-sm-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="driver_email"
                                                   placeholder="Email"
                                                   :value="driver.customer_email" :required="driver_required">
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="selectpicker"
                                                ...
                                                @foreach($customers as $commissioner)
                                                    <option value="{{$commissioner->customer_id}}">{{app()->getLocale() == 'ar'
                                                                    ? $commissioner->customer_name_full_ar
                                                                    : $commissioner->customer_name_full_en }}</option>
                                                @endforeach
                                            </select>
                                            ...
                                            <div class="card-body">
                                                <div class="table-responsive">
                                                    <table class="table text-nowrap mb-0">
                                                        ...
                                                        <tr v-for="car,index in filteredCars7">
                                                            <td>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="form-label">@lang('home.availability_of_the_reflective_triangle')</label>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="form-label">@lang('home.availability_of_a_fire_extinguisher')</label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="datetime-local" class="form-control" name="contractStartDate"
                                                   ...
                                                   required v-model="contractStartDate" @change="getDifferenceDate()"
                                            >
                                        </div>
                                    </div>
                                    <div class="col-sm-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="datetime-local" class="form-control" name="contractEndDate"
                                                   required v-model="contractEndDate" @change="getDifferenceDate()">
                                        </div>
                                    </div>
                                    <div class="col-sm-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="contractTypeCode" class="form-control" id="contractTypeCode"
                                                    onchange="contractType()" required>
                                                <option value="">@lang('home.choose') </option>
                                    ...
                                    <div class="col-sm-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            {{--<input type="number" class="form-control" name="contract_status"--}}
                                            {{--placeholder="active" value="1">--}}
                                    ...
                                    <div class="col-sm-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control"
                                                   v-model="rent_period" @change="getContractEndDate()">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-sm-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="allowedKmPerDay"
                                                   readonly :value="price_list.extra_kilometer" id="allowedKmPerDay">
                                        </div>
                                    </div>
                                    <div class="col-sm-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="extraKmCost"
                                                   readonly :value="price_list.extra_kilometer_price" required>
                                        </div>
                                    </div>
                                    <div class="col-sm-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name=""
                                                   readonly :value="price_list.hours_to_day">
                                        </div>
                                    </div>
                                    <div class="col-sm-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="allowedLateHours"
                                                   readonly :value="price_list.extra_hour" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="rentHourCost"
                                                   readonly :value="price_list.extra_hour_price" required>
                                        </div>
                                    </div>
                                    <div class="col-sm-6 col-md-6">
                                        <div class="form-group">
                                    ...
                                    <div class="col-sm-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="driverFarePerDay"
                                                   readonly :value="price_list.extra_driver" id="driverFarePerDay">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="driverFarePerHour"
                                                   readonly :value="parseFloat(price_list.extra_driver) / 12"
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 col-md-6">
                                        <div class="form-group">
                                            <label class="form-label">@lang('home.the_value_of_delivering_the_car_in_another_city_in_sar')</label>
                                            <input type="text" class="form-control"
                                                   placeholder="0.4" value="0">
                                        </div>
                                    </div>
                                    <div class="col-sm-6 col-md-6">
                                        <div class="form-group">
                                    ...
                                    <div class="col-sm-6 col-md-6">
                                        <div class="form-group">
                                            <label class="form-label">@lang('home.the_total_value_of_adding_drivers')</label>
                                            <input type="text" class="form-control"
                                                   placeholder="35" value="0">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6 col-md-6">
                                        <div class="form-group">
                                            <label class="form-label">@lang('home.discount')</label>
                                    ...
                                    <div class="col-sm-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="paid"
                                                   placeholder="300" required v-model="paid_up">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="file" class="form-control" name="sketchInfo" required>
                                        </div>
                                    </div>
...
@section('scripts')
    ...
    <script>
        ...
        // console.log(document.getElementsByName("contractStartDate")[0]);
        ...
        function extraDriver(el) {
            if (el.val() == 1) {
                $('#extraDriverCost').prop('required', trzue)
            } else {
        ...
        function showTab(n) {
            ...
            if (n == (x.length - 1)) {
                ...
                // document.getElementById("nextBtn").getAttribute('type', 'submit');
                console.log(document.getElementById("nextBtn").getAttribute('type'))
            } else {
        ...
        new Vue({
            ...
            computed: {
                ...
                filteredCars5: function () {
                    if (this.isLoaded == true) {
                        return this.filteredCars4.filter(car => {
                            return car.category_name_ar.match(this.car_category)
                        })
                    }
                },
                ...
                total_delay_cost: function () {
                    return this.daily_price * this.rent_period
                },
                total_before_discount: function () {
                    return this.daily_price * this.rent_period
                },
                final_total: function () {
                    var total_with_vat = this.total_before_discount * (1 + this.added_tax / 100);

                    return (total_with_vat - (total_with_vat * (this.discount_percentage / 100))).toFixed(2)
                },
                paid_message: function () {
                    if (parseFloat(this.paid_up) < parseFloat(this.daily_price)) {
                        return 'المدفوع أقل من التكلفة اليوميه';
                    } else {
                        return '';
                    }
                },
                remain_cost: function () {
                    return parseFloat(this.final_total) - parseFloat(this.paid_up).toFixed(2)
                }
            }
