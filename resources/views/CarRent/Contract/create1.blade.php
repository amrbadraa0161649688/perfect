        ...
        <div class="row d-flex justify-content-center align-items-center">
            <div class="col-md-12">
                <form action="{{route('car-rent.store')}}" method="post" class="contact-form"
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="selectpicker"
                                                    ...
                                                    v-on:change="getCustomer();getCars()"
                                                    required>
                                                <option value="">@lang('home.choose')</option>
                                                @foreach($customers as $customer)
                                                    <option value="{{$customer->customer_id}}"
                                                            @if(isset($customer_id) && $customer_id == $customer->customer_id) selected @endif>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-0">
                                            <div class="">
                                                <div class="">{{--هل االموفوض هو نفسه المستأجر--}}
                                                    <label
                                ...
                                <div class="row clearfix">
                                    <div class="col-md-12">
                                        <div class="card card-collapsed">
                                            ...
                                            <div class="card-body" style="max-height: 47rem;overflow-y: scroll;">
                                                        ...
                                                        <tr v-for="car,index in filteredCars">
                                                            <td>
                                                                <input type="radio" name="car_id"
                                                                       @click="getSelectedCar(car.car_id)"
                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="rentPolicyId" class="form-control" required
                                                ...
                                                @foreach($rent_policies as $rent_policy)
                                                    <option value="{{$rent_policy->system_code_id}}" @if($loop->index == 0) selected @endif>
                                                        {{
                                                        app()->getLocale() == 'ar'
                                    ...
                                    <div class="col-sm-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control"
                                                   v-model="rent_period" @change="getContractEndDate();initialPaidUp()"
                                                   required
                                                   min="1" name="days_count">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="receiveBranchCode" class="form-control">
                                                @foreach($branches as $branch)
                                    ...
                                    <div class="col-sm-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="returnBranchCode" class="form-control">
                                                @foreach($branches as $branch)
                                                    <option value="{{$branch->branch_code}}"
                                                            @if($branch->branch_id == session('branch')['branch_id'])
                                                                selected @endif>
                                    ...
                                    <div class="col-sm-6 col-md-6">
                                        <div class="form-group">
                                            <label class="form-label">@lang('home.actualReturnBranchId')</label>
                                            <select name="actualReturnBranchCode" class="form-control">
                                                @foreach($branches as $branch)
                                                    <option value="{{$branch->branch_code}}"
                                                            @if($branch->branch_id == session('branch')['branch_id'])
                                                                selected @endif>
                                    ...
                                    <div class="col-sm-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" name="paid"
                                                   required v-model="paid_up" min="1" @change="calculatePaid()">
                    ...
                    {{--                    <div class="form-section">--}}
                    {{--                        <h2 class="text-center">@lang('home.Contract_team_information')</h2>--}}

                    {{--                        --}}{{--                         البيانات التيم للعقد--}}
                    {{--                        <div class="card">--}}
                    {{--                            <div class="card-body">--}}
                    {{--                                <h3 class="card-title">--}}
                    {{--                                    <p style="font-weight: bold;font-size: 25px;">--}}
                    {{--                                        @lang('home.Contract_team_information')--}}
                    {{--                                    </p>--}}
                    {{--                                </h3>--}}
                    {{--                                <div class="row">--}}
                    {{--                                    <div class="col-sm-6 col-md-6">--}}
                    {{--                                        <div class="form-group">--}}
                    {{--                                            <label class="form-label">@lang('home.taam_status')</label>--}}
                    {{--                                            <input type="text" maxlength="50" name="taam_status" class="form-control"--}}
                    {{--                                                   placeholder="taam_status" v-model="taam_status">--}}
                    {{--                                        </div>--}}
                    {{--                                    </div>--}}
                    {{--                                    <div class="col-sm-6 col-md-6">--}}
                    {{--                                        <div class="form-group">--}}
                    {{--                                            <label class="form-label">@lang('home.taam_date')</label>--}}
                    {{--                                            <input type="text" maxlength="50" name="taam_date" class="form-control"--}}
                    {{--                                                   placeholder="taam_date" v-model="taam_date">--}}
                    {{--                                        </div>--}}
                    {{--                                    </div>--}}
                    {{--                                    <div class="col-sm-6 col-md-6">--}}
                    {{--                                        <div class="form-group">--}}
                    {{--                                            <label class="form-label">@lang('home.taam_location')</label>--}}
                    {{--                                            <input type="text" maxlength="50" name="taam_location" class="form-control"--}}
                    {{--                                                   placeholder="taam_location" v-model="taam_location">--}}
                    {{--                                        </div>--}}
                    {{--                                    </div>--}}
                    {{--                                </div>--}}
                    {{--                            </div>--}}
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-sm-6 col-md-4">
                                        <div class="form-group">
                                            <label class="form-label">@lang('home.tamm_number')</label>
                                            <input type="text"
                                                   class="form-control @error('tamm_enddate_hejri') is-invalid @enderror"
                                                   name="taam_number">
                                            @error('tamm_enddate_hejri')
                                    ...
                                    {{--تاريخ نهايه التفويض هجري--}}
                                    <div class="col-sm-6 col-md-4">
                                        <div class="form-group">
                                            <label for="tamm_enddate_hejri"
                                                   class="form-label"> @lang('home.tamm_enddate_hejri')</label>
                                            <input type="text"
                                                   class="form-control @error('tamm_enddate_hejri') is-invalid @enderror"
                                                   name="tamm_enddate_hejri"
                                                   id="tamm_enddate_hejri"
                                                   placeholder="@lang('home.tamm_enddate_hejri')">
                                            @error('tamm_enddate_hejri')
                                            <div class="invalid-feedback">
                                                {{$message}}
                                            </div>
                                    ...
                                    <div class="col-sm-6 col-md-4">
                                        <div class="form-group">
                                            <label
                                                class="form-label">@lang('home.tammExternalAuthorizationCountries')</label>
                                            <select
                                                class="selectpicker @error('authorizationTypeCode') is-invalid @enderror"
                                                data-live-search="true"
                                                name="authorizationTypeCode" id="authorizationTypeCode" required>
{{--                                                <option value="" disabled>@lang('home.choose')</option>--}}
                                                <option
                                                    value="1">@lang('home.internal')</option>
                                                <option
                                                    value="2">@lang('home.external')</option>
                                            </select>
                                            @error('authorizationTypeCode')
                                            <div class="invalid-feedback">
                                                {{$message}}
                                            </div>
                                            @enderror
...
@section('scripts')
    ...
    <script>
        ...
        $(function () {
            ...
            $("#tamm_enddate_hejri").hijriDatePicker();
    ...
    <script>
        new Vue({
            ...
            mounted() {
                ...
                this.rentPolicyId = '{{count($rent_policies)?$rent_policies[0]->system_code_id:''}}'
                if (this.customer_id) {
                    this.getCustomer()
                    this.getCars()
            ...
            methods: {
                ...
                calculatePaid() {
                    if (this.rent_period > 0 && this.paid_up <= 0) {
                        let total_day = this.rent_period ? (parseFloat(this.final_total) / this.rent_period).toFixed() : 0;
                        console.log('if1', total_day, this.rent_period);
                        if (parseFloat(this.paid_up) < total_day) {
                            this.price_disabled = true;
                            return 'المدفوع أقل من التكلفة الاجماليه لليوم';
                        } else {
                            this.price_disabled = false;
                            return '';
                        }
                    } else if (this.rent_period <= 0 && this.paid_up > 0) {
                        this.rent_period = 1;
                        let total_day = parseFloat(this.final_total).toFixed();
                        console.log('if2', total_day, this.rent_period);
                        if (parseFloat(this.paid_up) < total_day) {
                            this.price_disabled = true;
                            return 'المدفوع أقل من التكلفة الاجماليه لليوم';
                        } else {
                            this.rent_period = total_day > 0 ? Math.floor(this.paid_up / total_day) : 0;
                            this.price_disabled = false;
                        ...
                        let total_day = this.rent_period ? (parseFloat(this.final_total) / this.rent_period).toFixed() : 0;
                        console.log('else', total_day, this.rent_period);
                        if (parseFloat(this.paid_up) < total_day) {
                            this.price_disabled = true;
                            return 'المدفوع أقل من التكلفة الاجماليه لليوم';
                        } else {
                ...
                getSelectedCar(id) {
                    $.ajax({
                        type: 'GET',
                        data: {id: id},
                        url: '{{ route("api.carRent.getCarDetails") }}'
                    }).then(response => {
                        this.price_disabled = false
            ...
            computed: {
                ...
                filteredCars: function () {
                    console.log(this.plate_number, this.brand);
                    this.CarFiltered = this.cars;
                    if (this.isLoaded == true) {
                        if (this.plate_number) {
                            this.CarFiltered = this.CarFiltered.filter(car => {
                        ...
                        if (this.brand) {
                            this.CarFiltered = this.CarFiltered.filter(car => {
                                return car.brand_name_en.match(this.brand)
                            })
                        }
                        ...
                        if (this.car_model) {
                            this.CarFiltered = this.CarFiltered.filter(car => {
                                return car.model_name_en.match(this.car_model)
                            })
                        }
                        ...
                        if (this.tracker_status) {
                            this.CarFiltered = this.CarFiltered.filter(car => {
                                return car.tracker_status_en.match(this.tracker_status)
                            })
                        }
                        if (this.tracker_status) {
                            this.CarFiltered = this.CarFiltered.filter(car => {
                ...
                paid_message: function () {
                    let total_day = this.rent_period > 0 ? (parseFloat(this.final_total) / this.rent_period).toFixed() : 0;
                    if (parseFloat(this.paid_up) < total_day) {
                        this.price_disabled = true;
                        return 'المدفوع أقل من التكلفة الاجماليه لليوم';
                    } else {
                    ...
                    //         if(this.rent_period && !this.paid_up){
                    //             let total_day = this.rent_period?(parseFloat(this.final_total) / this.rent_period).toFixed():0;
                    //             console.log('if1', total_day, this.rent_period);
                    //             if (parseFloat(this.paid_up) < total_day) {
                    //                 this.price_disabled = true;
                    ...
                    //                 return '';
                    //             }
                    //         }else if(!this.rent_period && this.paid_up){
                    //             this.rent_period = 1;
                    //             let total_day = parseFloat(this.final_total).toFixed();
                    //             console.log('if2', total_day, this.rent_period);
                    //             if (parseFloat(this.paid_up) < total_day) {
                    ...
                    //
                    //
                    //         let total_day = (parseFloat(this.final_total) / this.rent_period).toFixed();
                    //             console.log('if', this.rent_period,total_day,this.paid_up);
                    //         total_day = !isNaN(total_day) && total_day > 0 ? total_day : 0;
                    //         if (parseFloat(this.paid_up) < total_day) {
                    //             this.price_disabled = true;
                    //             return 'المدفوع أقل من التكلفة الاجماليه لليوم';
                    //         } else {
                    //             let totalDay = this.rent_period > 0?Math.floor(this.paid_up / (parseFloat(this.final_total) / this.rent_period)):0;
                    //             this.rent_period = totalDay > 0 ? totalDay : 0;
                    //             this.price_disabled = false;
                    //             this.getContractEndDate();
                    //             return '';
                    //         }
                    ...
                    //         //     let total_day = (parseFloat(this.final_total) / this.rent_period).toFixed();
                    //         //     total_day = !isNaN(total_day) && total_day > 0 ? total_day : 0;
                    //         //     console.log('if', this.rent_period,total_day);
                    //         //     if (parseFloat(this.paid_up) < total_day) {
                    //         //         this.price_disabled = true;
                    //         //         return 'المدفوع أقل من التكلفة الاجماليه لليوم';
                    //         //     } else {
                    ...
                    //         //
                    //         //     this.rent_period = 1;
                    //         //     let totalDay = Math.floor(this.paid_up / parseFloat(this.final_total));
                    //         //     this.rent_period = totalDay > 0 ? totalDay : 0;
                    //         //     this.price_disabled = false;
                    //         //     this.getContractEndDate();
                    //         //     return '';
