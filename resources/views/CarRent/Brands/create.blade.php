        ...
        <div class="container-fluid">
            <div class="tab-content mt-3">
                ...
                <div class="tab-pane fade show active " id="data-grid" role="tabpanel">
                    ...
                    <form class="card" id="validate-form" action="{{ route('brands.store') }}"
                          method="post"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 form-group">
                                        ...
                                        <input type="text"
                                               ...
                                               placeholder="@lang('home.brand_name_ar')" value="{{old('brand_name_ar')}}" required>
                                        @error('brand_name_ar')
                                    ...
                                    <div class="col-md-6 form-group">
                                        ...
                                        <input type="text"
                                               ...
                                               placeholder="@lang('home.brand_name_en')" value="{{old('brand_name_en')}}" required>
                                        @error('brand_name_en')
                                        <div class="invalid-feedback">
                                            {{$message}}
                                        </div>
                                    ...
                                    <div class="col-md-6 form-group">
                                        <div class="mb-3">
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                    <input type="file" id="dropify-event" accept="image/*" class="@error('brand_logo_url') is-invalid @enderror"
                                                           name="brand_logo_url" required>
