                ...
                <form action="">
                    <div class="form-group">
                        <div class="input-daterange input-group" >
                            <input data-provide="datepicker" data-date-autoclose="true" class="form-control"  data-date-format="mm/dd/yyyy" name="start_date" id="start_date">
                            <span class="input-group-addon range-to">to</span>
                            <input data-provide="datepicker" data-date-autoclose="true" class="form-control" data-date-format="mm/dd/yyyy" name="end_date" id="end_date">
                        </div>
                    </div>
                </form>
            </div>
...
@section('scripts')
    ...
    <script type="text/javascript">
        ...
        function getData(){
            ...
            $.ajax({
                type: 'get',
                url :"{{route('fuel-station.price.history.data')}}",
                data:{
                    _token : "{{ csrf_token() }}",
