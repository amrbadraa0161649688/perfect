    ...
    <div class="section-body mt-3" id="app">
        <div class="container-fluid">
            <div class="tab-content mt-3">
                ...
                {{-- Form To Update EmployeeCertificate--}}
                <form class="card" id="validate-form" action="{{route('employee-certificates-update' , $certificate->emp_certificate_id)}}"
                      method="post"
                    ...
                    <div class="card-body">
                            ...
                            <div class="row">
                                    ...
                                    <select class=" form-select form-control"
                                        ...
                                        @foreach($countries as $country)
                                            <option value="{{$country->system_code_id}}"
                                                    @if($certificate->emp_certificate_country == $country->system_code_id) selected @endif >
                                                @if(app()->getLocale() == 'ar')
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control "
                                           ...
                                           value="{{$certificate->emp_certificate_collage}}" required>
                                </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control"
                                           ...
                                           value="{{$certificate->emp_certificate_type}}" required>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="date" class="form-control"
                                           ...
                                           value="{{$certificate->emp_certificate_start_date}}" required>
                                </div>
                                <div class="col-md-4">
                                    <label for="recipient"
                                    ...
                                    <input type="date" class="form-control"
                                           ...
                                           value="{{$certificate->emp_certificate_end_date}}" required>
                                </div>
                                <div class="col-md-4">
                                    <label for="recipient"
                                    ...
                                    <input type="number" class="form-control"
                                           ...
                                           value="{{$certificate->emp_certificate_duration}}" required>
                                </div>
                        ...
                        <div class="card-footer">
                            <button type="submit" class="btn btn-primary mr-2"
                                    id="update_certificate">@lang('home.save')</button>
                        </div>
                    </div>
                </form>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#emp_certificate_start_date').change(function () {
                ...
                $('#update_certificate').removeAttr('disabled', 'disabled')
            });
