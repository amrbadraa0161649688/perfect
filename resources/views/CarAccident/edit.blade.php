            ...
            <div class="tab-content mt-3">
                ...
                <div class="tab-pane fade show active" id="data-grid" role="tabpanel">
                    <div class="col-lg-12">
                        ...
                        <form action="{{route('car-accident.update',$car_accident->car_accident_id)}}"
                                    ...
                                    <div class="row mt-3 mb-3"
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control" name="car_accident_claim_no"
                                                   value="{{$car_accident->car_accident_claim_no}}" required>
                                        </div>


                                        {{--تاريخ التسليم--}}
                                        <div class="col-md-4">
                                            <label class="form-label">@lang('home.delivery_date_claim')</label>
                                            <input type="date" class="form-control" name="car_accident_date_close"
                                                   value="{{$car_accident->car_accident_date_close}}" required>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control" name="claim_receive_no"
                                                   value="{{$car_accident->claim_receive_no}}" required>
                                        </div>
