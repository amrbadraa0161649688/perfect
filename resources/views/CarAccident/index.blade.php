                                    ...
                                    <div class="table-responsive table_e2">
                                        <table class="table table-hover table-vcenter table_custom text-nowrap spacing5 text-nowrap mb-0">
                                            ...
                                            <tr>
                                                ...
                                                <th>@lang('home.contract_number_or_itinerary_number')</th>
                                                <th>@lang('home.plate_number')</th>
                                                <th>@lang('home.accident_type')</th>
                                                <th>@lang('home.appreciation_body')</th>
                                                <th>@lang('home.appreciation_status_number')</th>
                                            ...
                                            $car_accident->branch->branch_name_en}}</td>
                                                    <td>
                                                        @if($car_accident)
                                                            {{$car_accident->contract->contract_code}}
                                                        @else
                                                            <p>لا يوجد عقد</p>
                                                        @endif
                                                    </td>
                                                    <td>{{$car_accident->car->full_car_plate}}</td>
                                            ...
                                            $car_accident->accidentType->system_code_name_en}}</td>
                                                    <td>
                                                        ...
                                                        @else
                                                            <p>لا يوجد</p>
                                                        @endif</td>
                                                    <td>{{$car_accident->car_accident_ref}}</td>
                                                    ...
                                                    <td>
                                                        @if($car_accident->car_accident_payment == 0)
                                                            <form action="{{ route('car-accident.delete',$car_accident->car_accident_id) }}"
                                                                  method="post">
                                                                @csrf
                                                                @method('delete')
                                                    ...
                                                    <td>
                                                        <a href="{{ route('car-accident.edit',$car_accident->car_accident_id) }}"
                                                           class="btn btn-primary btn-sm" title="show">
