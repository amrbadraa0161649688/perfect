            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('PriceList-cargo.update',$price_list->price_list_id) }}" method="post">
                                @csrf
                                @method('put')
                                <div class="row">
                                    <div class="col-md-12">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <input type="date" class="form-control" name="price_list_start_date"
                                                           ...
                                                           value="{{$price_list->price_list_start_date}}" required>
                                                </div>
                                            ...
                                            <select class="selectpicker form-control" multiple data-live-search="true"
                                                ...
                                                <td class="text-center">
                                                    <input type="decimal"
                                                           ...
                                                           class="form-control no-arabic  numbers-only"
                                                           id="cost_fees"  step="0.01"
                                                           name="old_cost_fees[]" value="0.00" required>
                                                </td>
                                            ...
                                            <tr id="add_clone" class="clone" v-for="(price_list,index) in priceLists">
                                                ...
                                                <td class="text-center">
                                                    <input type="decimal"
                                                           ...
                                                           class="form-control no-arabic  numbers-only" step="0.01"
                                                           id="cost_fees"
                                                           name="cost_fees[]" value="0.00">
                                                </td>
            ...
            methods: {
                ...
                deleteRow(index) {
                    $.ajax({
                        ...
                        url: '{{ route('PriceList-cargo.delete') }}'
                    }).then(response => {
