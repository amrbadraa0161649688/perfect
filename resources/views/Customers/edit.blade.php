    ...
    <div class="section-body mt-3" id="app">
        <div class="container-fluid">
            <div class="tab-content mt-3">
                    ...
                    <form class="card" id="validate-form" action="{{ route('Customers.update',$customer->customer_id) }}"
                          method="post"
                            ...
                            <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <label for="recipient-name"
                                                       class="col-form-label " readonly> @lang('customer.customer_code')  </label>
                                        ...
                                        <div class="col-md-3">
                                                ...
                                                <select class="form-select form-control is-invalid"
                                                    ...
                                                    @foreach($sys_customer_category as $sys_customer_categorys)
                                                        ...
                                                        @if($sys_customer_categorys->system_code == $customer->customer_category)
                                                            selected @endif>
                                                                @if(app()->getLocale() == 'ar')
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input type="text" class="form-control" name="postal_box"
                                                   id="postal_box" value="{{$customer->postal_box}}" >
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" class="form-control " name="addition_per" 
                                                id="addition_per" value="{{$customer->customer_addition_rate}}" 
                                                >
                                    </div>
                                    <div class="col-md-3">
                                        <label for="recipient"
                                        ...
                                        <input type="text" class="form-control "
                                                name="discount_per" 
                                                id="discount_per"
                                                value="{{$customer->customer_discount_rate}}"
                                               >
                                    </div>
                                    <div class="col-md-3">
                                        <label for="recipient"
                                                class="col-form-label"> @lang('customer.vat_per') </label>
                                        <input type="text" class="form-control " name="vat_per" 
                                                id="vat_per"value="{{$customer->customer_vat_rate}}"
                                                >
                                    </div>
                                    <div class="col-md-3">
                                            <label for="recipient"
                                ...
                                <div class="mb-2">
                                    <div class="row">
                                        ...
                                        <input type="text" class="form-control " name="build_no"
                                               id="build_no" value="{{$customer->build_no}}"  >
                                    </div>
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <input type="text" class="form-control" name="unit_no"
                                               id="unit_no" value="{{$customer->unit_no}}"  >
                                    </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <input type="text" class="form-control" name="customer_address_en"
                                                   id="customer_address_en" value="{{$customer->customer_address_en}}" >
                                        </div>
