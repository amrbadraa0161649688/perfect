...
<div class="modal fade" id="exampleModal{{$row->uuid}}" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
                ...
                <form action="{{ route('maintenance-card.addBondWithJournal') }}" method="post">
                    ...
                    <div class="row">
                        ...
                        <input type="hidden" name="transaction_id"
                               value="{{$row->mntns_cards_id ? $row->mntns_cards_id : ''}}">
            ...
            ->where('company_group_id', $row->company->company_group_id)->get() as $system_code)
            ...
            ->where('company_group_id', $row->company->company_group_id)->get() as $payment_method)
            ...
            ->where('company_group_id', $row->company->company_group_id)->get() as $bank)
