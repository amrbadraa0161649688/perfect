                                    ...
                                    <div class="mb-3">
                                        <div class="row">
                                            ...
                                            <input type="hidden" class="form-control" name="card_uuid"
                                                   ...
                                                   value="{{ $card->uuid }}">
                                            <div class="col-md-3">
                                                <label for="recipient-name" class="col-form-label ">  @lang('maintenanceType.mntns_card_no')
                                                     </label>
                                            ...
                                            <div class="col-md-3">
                                                <label for="recipient-name" class="col-form-label ">   @lang('maintenanceType.mntns_card_types')
                                                     </label>
                                            ...
                                            <div class="col-md-3">
                                                <label for="recipient-name" class="col-form-label"> @lang('maintenanceType.mntns_type')
                                                     </label>
                                            ...
                                            <div class="col-md-3">
                                                <label for="recipient-name" class="col-form-label"> @lang('maintenanceType.mntns_card_cus_type')
                                                     </label>
                                                <select class="form-select form-control "
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <label for="recipient-name" class="col-form-label ">  @lang('maintenanceType.mntns_card_status')
                                                     </label>
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <label for="recipient-name" class="col-form-label "> @lang('maintenanceType.mntns_counter_car')
                                                </label>
                                                <input type="number" class="form-control" name="mntns_cars_meter"
                                                       id="mntns_cars_meter" value="{{($card->mntns_cars_meter)}}">
                                            </div>
                                            <div class="col-md-4">
                                                <label for="recipient-name" class="col-form-label"> @lang('maintenanceType.mntns_notes') </label>
