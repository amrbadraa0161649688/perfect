    ...
    <div class="container-fluid">
        <div class="tab-content mt-3">
            <div class="tab-pane fade show active " id="data-grid" role="tabpanel">
                <form class="card" id="validate-form" action="{{ route('maintenance-car.store') }}" method="post" enctype="multipart/form-data" id="submit_user_form">
                @csrf    
                <div class="card-header">
                        @lang('maintenanceCar.maintenance_car_add')
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            ...
                                            <option value="" selected> choose</option>    
                                                ...
                                                <option value="{{$cus->customer_id}}" > {{$cus->getCustomerName()}} </option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="col-md-3">
                    ...
                    <div class="card-footer">
                        ...
                        <button type="submit" class="btn btn-primary mr-2" data-bs-dismiss="modal" id="create_emp">@lang('maintenanceCar.save')</button>
                    </div>
