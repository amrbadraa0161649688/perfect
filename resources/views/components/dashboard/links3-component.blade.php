        ...
        <div class="container-fluid">
            ...
            <div class="col-6 col-md-4 col-xl-2">
                ...
                <div class="col-6 col-md-4 col-xl-2">
                    <div class="card">
                        <div class="card-body ribbon">
                            <a href="{{ route('WaybillsCargo2') }}" class="my_sort_cut text-muted">
                ...
                <div class="col-6 col-md-4 col-xl-2">
                    <div class="card">
                        <div class="card-body ribbon">
                            <a href="{{ route('invoicesCargo2') }}" class="my_sort_cut text-muted">
                ...
                <div class="col-6 col-md-4 col-xl-2">
                    <div class="card">
                        <div class="card-body ribbon">
                            <a href="{{ route('main3.dashboard') }}"  class="my_sort_cut text-muted">
