    ...
    <div class="container-fluid">
        <div class="tab-content mt-3">
            <div class="tab-pane fade show active" id="data-grid" role="tabpanel">
                {{--main data--}}
                <form action="{{route('maintenanceCardTanks.update',$maintenance_hd->mntns_cards_id)}}" method="post">
                    @csrf
                    @method('put')
                    <div class="card-body">
                        <div class="row card">
                ...
                <table class="table table-bordered card_table" id="internal_maintenance_table">
                    ...
                    <tr>
                        <th colspan="10">
                            <div class="col-md-12">
                                <div class="mb-3">
                                    <form action="{{route('maintenanceCardTanks.storeDetails')}}" method="post"
                                          id="internal">
                                        @csrf
                                        <div class="row">
                    ...
                    <tr>
                        ...
                        <td class="ctd table-active">
                            <a href="{{route('maintenanceCardTanks.deleteItem',$internalDetail->mntns_cards_dt_id)}}"
                ...
                <table class="table table-bordered card_table" id="external_maintenance_table">
                    ...
                    <tr id="{--><!--{ $external->uuid }}">
                        ...
                        <td class="ctd">
                            <a href="{{route('maintenanceCardTanks.deleteItem',$external->mntns_cards_dt_id)}}"
                               class="btn btn-danger"><i
                                    class="fa fa-trash"></i></a>
                        </td>
                    </tr>
                ...
                <table class="table table-bordered card_table" id="part_maintenance_table">
                    ...
                    <tr id="{{ $part->uuid }}">
                        ...
                        <td class="ctd">
                            <a href="{{route('maintenanceCardTanks.deleteItem',$part->mntns_cards_dt_id)}}"
                               class="btn btn-danger"><i
                                    class="fa fa-trash"></i></a>
                        </td>
                    </tr>
        ...
        methods: {
            getMaintenanceTypeDts() {
                $.ajax({
                    ...
                    url: '{{ route("maintenanceCardTanks.getMaintenanceTypeDts") }}'
                }).then(response => {
            ...
            getStoreItem() {
                $.ajax({
                    ...
                    url: '{{ route("maintenanceCardTanks.getStoreItemDt") }}'
                }).then(response => {
