        ...
        <div class="container-fluid">
            <div class="tab-content mt-3">
                <div class="tab-pane fade show active" id="data-grid" role="tabpanel">
                    {{--main data--}}
                    <form action="{{route('maintenanceCard.update',$maintenance_hd->mntns_cards_id)}}" method="post">
                        @csrf
                        @method('put')
                        <div class="card-body">
                            <div class="row card">
                    ...
                    <table class="table table-bordered card_table" id="internal_maintenance_table">
                        ...
                        <tr>
                            <th colspan="10">
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        <form action="{{route('maintenanceCard.storeDetails')}}" method="post"
                                              id="internal">
                                            @csrf
                                            <div class="row">
                        ...
                        @foreach($maintenance_hd->internalDetails as $internalDetail)
                            <tr>
                                ...
                                <td class="ctd table-active">
                                    <a href="{{route('maintenanceCard.deleteItem',$internalDetail->mntns_cards_dt_id)}}"
                    ...
                    <table class="table table-bordered card_table" id="external_maintenance_table">
                        ...
                        @foreach($maintenance_hd->externalDetails as $key => $external)
                            ...
                            <tr id="{--><!--{ $external->uuid }}">
                                ...
                                <td class="ctd">
                                    <a href="{{route('maintenanceCard.deleteItem',$external->mntns_cards_dt_id)}}"
                                       class="btn btn-danger"><i
                                                class="fa fa-trash"></i></a>
                                </td>
                            </tr>
                    ...
                    <table class="table table-bordered card_table" id="part_maintenance_table">
                        ...
                        @foreach($maintenance_hd->partDetails as $key => $part)
                            ...
                            <tr id="{{ $part->uuid }}">
                                ...
                                <td class="ctd">
                                    <a href="{{route('maintenanceCard.deleteItem',$part->mntns_cards_dt_id)}}"
                                       class="btn btn-danger"><i
                                                class="fa fa-trash"></i></a>
                                </td>
                            </tr>
            ...
            methods: {
                getMaintenanceTypeDts() {
                    $.ajax({
                        ...
                        url: '{{ route("maintenanceCard.getMaintenanceTypeDts") }}'
                    }).then(response => {
                ...
                getStoreItem() {
                    $.ajax({
                        ...
                        url: '{{ route("maintenanceCard.getStoreItemDt") }}'
                    }).then(response => {
