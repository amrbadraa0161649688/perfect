...
@section('content')
    ...
    <div class="section-body mt-3" id="app">
        ...
        <div class="row">
            <div class="col-md-12">
                <a href="{{route('maintenanceCardServices.create')}}" class="btn btn-primary btn-lg">{{__('Add New Card')}}</a>
            </div>
        </div>
        <div class="card-body">
                ...
                <table class="table table-striped card_table">
                    ...
                    @foreach($maintenance_cards as $maintenance_card)
                        <tr>
                            ...
                            <td>
                                <a href="{{route('maintenanceCardServices.create2',$maintenance_card->mntns_cards_id)}}"
