...
@section('content')
        ...
        <div class="container-fluid">
            <div class="tab-content mt-3">
                ...
                <div class="tab-pane fade show active " id="data-grid" role="tabpanel">
                    ...
                    <form class="card" id="validate-form" action="{{ route('Suppliers.store') }}"
                          method="post"
                        ...
                        <div class="card-body">
                            ...
                            <div class="font-25" style="text-decoration: underline">
                                @lang('customer.add_new_supplier')
                            </div>
                            <div class="row">
                                <div class="col-md-9">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <input type="text" class="form-control"
                                                       ...
                                                       id="customer_name_full_ar" placeholder="@lang('home.name_ar')" readonly
                                                       oninput="this.value=this.value.replace( /[^ء-ي]/g,' ');" required>
                                            </div>
                                            <div class="col-md-4">
                                                <label for="recipient-name"
                                                ...
                                                <input type="text" class="form-control"
                                                       ...
                                                       id="customer_name_full_en" placeholder="@lang('home.name_en')" readonly
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <input type="number" class="form-control is-invalid" name="customer_identity"
                                                       id="customer_identity" placeholder="@lang('home.identity')" required>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <input type="text" class="form-control is-invalid" name="customer_name_1_ar"
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <input type="text" class="form-control " name="customer_name_2_ar"
                                                       id="customer_name_2_ar" placeholder="@lang('home.second_name_ar')"
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <input type="text" class="form-control" name="customer_name_4_ar"
                                                       id="customer_name_4_ar" placeholder="@lang('home.fourth_name_ar')"
                                    ...
                                    <div class="mb-3">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <select class="form-select form-control is-invalid" name="customer_status"
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        ...
                                        <input type="number" class="form-control is-invalid" name="customer_mobile"
                                               id="customer_mobile" placeholder="@lang('customer.private_mobile')" required>

                                    </div>
                                    <div class="col-md-3">
                                        <label for="recipient-name"
                                               class="col-form-label"> @lang('customer.country_code') </label>
                                        <select class="selectpicker"  data-live-search="true" name="customer_mobile_code"
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" class="form-control" name="customer_address_2"
                                               id="customer_address_2" placeholder="@lang('home.po_box_postal')" >
                                    </div>
   ...
   <script>
    $(document).ready(function () {
        ...
        $('#customer_name_full_en').change(function () {
            if ($('#customer_name_full_en').val().length < 3) {
                $('#customer_name_full_en').addClass('is-invalid')
                $('#create_emp').attr('disabled', 'disabled')
            } else {
                $('#customer_name_full_en').removeClass('is-invalid')
                $('#create_emp').removeAttr('disabled', 'disabled')
            }
        });
        ...
        $('#customer_name_1_en').keyup(function () {
            if ($('#customer_name_1_en').val().length < 3) {
                $('#customer_name_1_en').addClass('is-invalid')
                $('#create_emp').attr('disabled', 'disabled')
            } else {
                $('#customer_name_1_en').removeClass('is-invalid')
                $('#create_emp').removeAttr('disabled', 'disabled')
            }
        });
        
        $('#customer_name_4_en').keyup(function () {
            if ($('#customer_name_4_en').val().length < 3) {
                $('#customer_name_4_en').addClass('is-invalid')
                $('#create_emp').attr('disabled', 'disabled')
            } else {
                $('#customer_name_4_en').removeClass('is-invalid')
                $('#create_emp').removeAttr('disabled', 'disabled')
            }
        });
