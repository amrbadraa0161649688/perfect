...
<div class="container-fluid">
                            ...
                            <div class="col-md-3">
                                <button type="button"  class="btn btn-primary" data-toggle="modal" data-target="#exampleModal">
                                    ...
                                    <a href="{{route('Suppliers.create')}}"  class="btn btn-primary" >
                                        <i class="fe fe-plus mr-2"></i>@lang('customer.add_supplier')
                                    </a>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover table-light  yajra-datatable">
                            <thead class="table-primary">
                            <tr class="red"> 
                                <th class="sorting" style = "width": 10px
                               ></th>
                               
                                <th>@lang('customer.supplier_no')</th>
                                <th>@lang('customer.supplier_name')</th>
                                <th>@lang('customer.supplier_type')</th>
