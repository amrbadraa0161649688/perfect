<table class="table table-bordered card_table" id="item_table">
    <tbody >
                    ...
                    <div class="mb-3">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" name="sales_cars_chasie_no" id="sales_cars_chasie_no" value="">
                            </div>
                            <div class="col-md-3">
                                <label for="recipient-name" class="col-form-label "> @lang('sales_car.car_plate_no') </label>
                                <input type="text" class="form-control" name="sales_cars_plate_no" id="sales_cars_plate_no" value="">
                            </div>
                            ...
                            <div class="col-md-2">
                                ...
                                <input type="number" class="form-control" name="store_vou_qnt_i" id="store_vou_qnt_i" value="1" readonly>
                            </div>
                            ...
                            <div class="col-md-2">
                                ...
                                <input type="text" class="form-control" name="sales_cars_color" id="sales_cars_color" value="">
                            </div>

                            <div class="col-md-2">
                                <label for="recipient-name" class="col-form-label "> @lang('sales_car.car_model') </label>
                                <input type="text" class="form-control" name="sales_cars_model" id="sales_cars_model" value="">
                            </div>

                            <div class="col-md-2">
                                <label for="recipient-name" class="col-form-label "> سعر البيع </label>
                                <input type="text" class="form-control" name="sales_cars_sales_amount" id="sales_cars_sales_amount" value="">
                            </div>
        ...
        <tr>
            ...
            <th class="ctd table-active" > @lang('sales_car.car_color') </th>
            <th class="ctd table-active" > @lang('sales_car.car_model') </th>
            ...
            <!-- <th class="ctd table-active" style="width:10%"> @lang('sales_car..dic_type') </th>
            <th class="ctd table-active" style="width:10%"> @lang('sales_ca..disc') </th>
            <th class="ctd table-active" style="width:10%"> @lang('sales_car..totl_disc') </th> -->
        ...
        @foreach($sales->details as $key => $d)
            ...
            <tr id="{{ $d->uuid }}">
                ...
                <td class="ctd">   {{ optional($d->car)->sales_cars_color }}  </td>
                <td class="ctd">   {{ optional($d->car)->sales_cars_model }}  </td>
