        ...
        <div class="card">
                ...
                <div class="header-action">
                    <!-- foreach(session('job')->permissions as $job_permission) -->
                        <!-- if($job_permission->app_menu_id == 8 && $job_permission->permission_add) -->
                            <div class="header-action">
                                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#create_receive_modal">
                                    <i class="fe fe-plus mr-2"></i>  @lang('sales_car.add_receive_button')
                                </button>
                            </div>
                        <!-- endif -->
                    <!-- endforeach -->
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-bordered receiving_table">
                        <thead>
                        <tr>
                            <th>No</th>
                            <th> @lang('sales_car.branch') </th>
                            <th> @lang('sales_car.receive_no') </th>
...
@include('salesCar.purchase.receiving.create_receive') 
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        url = "{{ route('sales-car-receiving.data.table', ':id') }}";
