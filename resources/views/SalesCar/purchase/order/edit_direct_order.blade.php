                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control" name="store_acc_name" id="store_acc_name" value="{{$sales->store_acc_name}}" disabled>
                                        </div>
                                        <div class="col-md-4">
                                            <label for="recipient-name" class="col-form-label "> @lang('sales_car.vat_no') </label>
                                            <input type="number" class="form-control" name="store_acc_tax_no" id="store_acc_tax_no" value="{{$sales->store_acc_tax_no}}" disabled>
                                        </div>
                                        <div class="col-md-4">
                                            <label for="recipient-name" class="col-form-label"> @lang('sales_car.payment_method')  </label>
                                            <select class="form-select form-control" name="store_vou_pay_type" id="store_vou_pay_type" required disabled>
                                                <option value="" selected> choose</option>    
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                           <label for="recipient-name" class="col-form-label">@lang('sales_car.note') </label>
                                            <textarea rows="2" class="form-control" name="store_vou_notes" id="store_vou_notes" placeholder="Here can be your note" value="" disabled> {{$sales->tore_vou_notes }}</textarea>
                                        </div>
                                        <div class="col-md-4">
                                            <br>
                                            <br>
                        ...
                        <div class="col-md-12">
                            <div class="mb-3"> 
                                ...
                                <div class="table-responsive">
                                    @include('salesCar.purchase.order.table.direct_item_table')
                                </div>
                            </div>
                        </div>
...
@section('scripts')
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#store_vou_qnt_p').change(function()  {
                if($('#brand_id').val() == '' || $('#brand_dt').val() == '')
                {
                    $('#store_vou_qnt_p').val(0)
                    return toastr.warning('لابد من اختيار الصنف');
                }
                $('#store_vou_item_total_price').val($('#store_vou_qnt_p').val() * $('#store_vou_item_price_unit').val());
        ...
        function saveItemRow()
        {
            ...
            row_data = {
                ...
                'store_vou_qnt_p' : parseFloat($('#store_vou_qnt_p').val()),
        ...
        function updateItemTable(rowNo,rowData,uuid,total)
        {
            ...
            '<tr id='+uuid+'>'+
                ...
                '<td  class="ctd" id="'+'tr'+rowNo+'store_vou_qnt_p">'+ rowData['store_vou_qnt_p'] +'</td>'+
        ...
        // qty_input = document.getElementById("store_vou_qnt_p");
