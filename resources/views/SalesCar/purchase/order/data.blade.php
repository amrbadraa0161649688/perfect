                        ...
                        if($job_permission->app_menu_id == 8 && $job_permission->permission_add) -->
                            <div class="header-action">
                                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#create_order_modal">
                                    <i class="fe fe-plus mr-2"></i>  @lang('sales_car.add_order_button')
                                </button>
                            </div>
                        <!-- endif
                    endforeach -->
...
@include('SalesCar.purchase.order.create_order') 
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        url = "{{ route('sales-car-order.data.table', ':id') }}";
