<table class="table table-bordered card_table" id="item_table">
    <tbody >
                    ...
                    <div class="mb-3">
                        <div class="row"> 
                            ...
                            <div class="col-md-2">
                                ...
                                <select class="form-select form-control car" name="store_vou_item_id" id="store_vou_item_id" data-live-search="true" required>
                                    <option value="" selected> choose</option>  
                                </select>
                            </div>
                            ...
                            <div class="col-md-1">
                                ...
                                <input type="number" class="form-control" name="store_vou_qnt_q" id="store_vou_qnt_q" value="1" readonly>
                            </div>
        ...
        <tr>
            ...
            <th class="ctd table-active"> @lang('sales_car.car_add_amount') </td>
