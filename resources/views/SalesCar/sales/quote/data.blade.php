        ...
        <div class="card">
                        ...
                        <!-- if($job_permission->app_menu_id == 93 && $job_permission->permission_add) -->
                            <div class="header-action">
                                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#create_quote_modal">
                                    <i class="fe fe-plus mr-2"></i>  @lang('sales_car.add_quote_button')
                                </button>
                            </div>
                        <!-- endif -->
                    <!-- endforeach -->
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-bordered quote_table">
                        <thead>
                        <tr>
                            <th>No</th>
                            <th> @lang('sales_car.branch') </th>
                            <th> @lang('sales_car.quote_no') </th>
                            ...
                            <th> @lang('sales_car.quote_status') </th>
...
@include('salesCar.sales.quote.create_quote') 
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        url = "{{ route('sales-car-quote.data.table', ':id') }}";
