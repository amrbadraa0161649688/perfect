                ...
                <div class="header-action">
                    <!-- foreach(session('job')->permissions as $job_permission) -->
                        <!-- if($job_permission->app_menu_id == 65 && $job_permission->permission_add) -->
                            <div class="header-action">
                                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#create_inv_modal">
                                    <i class="fe fe-plus mr-2"></i>  @lang('sales_car.add_inv_button')
                                </button>
                            </div>
                        <!-- endif -->
                    <!-- endforeach -->
                ...
                <div class="table-responsive">
                    <table class="table table-bordered inv_table">
                        ...
                        <tr>
                            ...
                            <th> @lang('sales_car.inv_no') </th>
                            <th> @lang('sales_car.create_date') </th>
                            <th> @lang('sales_car.customer_name') </th>
...
@include('salesCar.sales.inv.create_inv') 
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        url = "{{ route('sales-car-inv.data.table', ':id') }}";
        ...
        var table = $('.inv_table').DataTable({
            ...
            buttons: [
                ...
                { extend: 'excel', text: '{{ trans('sales.excel_button') }}' , charset: 'UTF-8', fieldSeparator: ';', bom: true, filename: 'item export', title: 'item export' },
                { extend: 'print', text: '{{ trans('sales.print_button') }}' , charset: 'UTF-8', fieldSeparator: ';', bom: true, filename: 'item export', title: 'الاصناف' },
                { extend: 'colvis', text: '{{ trans('sales.colvis') }}' , charset: 'UTF-8', fieldSeparator: ';', bom: true, filename: 'item export', title: 'item export' }
            ],
            language: {
                search: "بحث",
