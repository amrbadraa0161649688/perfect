    ...
    <table class="table table-bordered card_table" id="item_table">
        <tbody >
            <tr>
                ...
                <th class="ctd table-active"> المتبقي  </th>
                <th class="ctd table-active"> الاضافات  </th>
                <th class="ctd table-active fitwidth" style="width:50%"> @lang('sales_car.unit_price') </th>
                <th class="ctd table-active fitwidth" style="width:50%"> @lang('sales_car.total') </th>
                ...
                <th class="ctd table-active fitwidth" style="width:50%"> @lang('sales_car.vat') </th>
                <th class="ctd table-active fitwidth" style="width:50%">  @lang('sales_car.net_amount') </th>
            ...
            @foreach($sales_request->details as $key => $d)
                ...
                <tr id="{{ $d->uuid }}">
                    ...
                    <td class="ctd"> {{ $d->brand->brand_name_en }}  </td>
                    <td class="ctd"> {{ $d->brandDT->brand_dt_name_en }}  </td>
                    ...
                    <td class="ctd"> 
                        <input type="text" class="form-control" name="{{$d->uuid}}" id="sales_cars_add_amount_{{$d->uuid}}" value="{{ optional($d->car)->sales_cars_add_amount }}"  onchange="calculateTotal(this)" readonly>
                    </td>
                    <td class="ctd"> 
                    ...
                    <td class="ctd">
                        <select class="form-select form-control" name="{{$d->uuid}}" id="store_vou_disc_type_{{$d->uuid}}" data-live-search="true" onchange="calculateTotal(this)" >
