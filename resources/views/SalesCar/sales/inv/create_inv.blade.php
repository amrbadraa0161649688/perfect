                    ...
                    <div class="col-md-12">
                        <div class="mb-3">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <div class="custom-controls-stacked">
                                        ...
                                        <label class="custom-control custom-radio custom-control-inline">
                                            <input type="radio" class="custom-control-input" name="create_tyep" id="create_tyep" value="new" >
                                            <span class="custom-control-label">@lang('sales_car.add_inv_button')</span>
                                        </label>

                                        <label class="custom-control custom-radio custom-control-inline">
                                            <input type="radio" class="custom-control-input" name="create_tyep" id="create_tyep" value="from_request">
                                            <span class="custom-control-label">استيراد عرض سعر </span>
                                        </label>
                            ...
                            <div class="row" id="from_request" style="display:none;">
                                <div class="col-md-6">
                                    <label for="recipient-name" class="col-form-label "> رقم عرض سعر </label>
                ...
                <div class="modal-body">
                    ...
                    <form id="quote_data_form"  enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <select class="selectpicker show-tick form-control is-invalid" data-live-search="true" name="store_acc_no" id="store_acc_no" required>
                                            ...
                                            <div class="col-md-4">
                                                <label for="recipient-name" class="col-form-label ">  @lang('sales_car.customer_name') </label>
                            ...
                            <div   class="modal-footer" id= "invadd">
                                ...
                                <button  type="button" id="btnSave" class="btn btn-success forward btn-block" onclick="saveDirectRequest()">حفـظ </button>
...
<script type="text/javascript">
    ...
    function calculateTotal(e)
    {
        ...
        sales_cars_add_amount = parseFloat($('#sales_cars_add_amount_'+e.name).val()); 
        ...
        store_vou_qnt_o = parseFloat($('#store_vou_qnt_o_'+e.name).val());
        store_vou_item_total_price_amount = (unit_price + sales_cars_add_amount) * parseFloat(store_vou_qnt_o);
    ...
    function saveDirectRequest()
    {
        // if($('.is-invalid').length > 0){
        //     return toastr.warning('تاكد من ادخال كافة الحقول');
        // }
        url = '{{ route('sales-car-direct-inv.store') }}'
        ...
        $.ajax({
            ...
            {
                toastr.success(data.msg);
                url =  '{{ route("sales-car-direct-inv.edit", ":id") }}';
