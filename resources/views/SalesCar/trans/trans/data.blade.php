        ...
        <div class="card">
                        ...
                        <!-- if($job_permission->app_menu_id == 82 && $job_permission->permission_add) -->
                            <div class="header-action">
                                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#create_trans_modal">
                                    <i class="fe fe-plus mr-2"></i>  @lang('sales_car_trans.add_trans_button')
                                </button>
                            </div>
                        <!-- endif -->
                    <!-- endforeach -->
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-bordered trans_table">
                        <thead>
                        <tr>
                            <th>No</th>
                            <th> كود اذن التحويل </th>
                            <th> @lang('sales_car_trans.source_branch') </th>
                            <th> @lang('sales_car_trans.source_store') </th>
                            <th> @lang('sales_car_trans.dest_branch') </th>
                            <th> @lang('sales_car_trans.dest_store') </th>
                            <th> @lang('sales_car_trans.create_date') </th>
                            <th> @lang('sales_car_trans.total') </th>
                            <th>Action</th>
                        </tr>
                        </thead>
                        <tbody>
...
@include('salesCar.trans.trans.create_trans') 
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        url = "{{ route('sales-car-transfer-trans.data.table', ':id') }}";
