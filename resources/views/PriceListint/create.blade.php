                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="font-25" bold>
                                        @lang('customer.add_price_list_int')
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('PriceList-int.store') }}" method="post">
                                @csrf
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                    ...
                                    <div class="col-md-12">
                                        <table class="table table-bordered table-condensed" id="add_table">
                                            ...
                                            <tr id="add_clone" class="clone" v-for="(pricelist,index) in pricelists">
                                                ...
                                                <td>
                                                    <input type="number" v-model="pricelists[index]['cost_fees']"
                                                           class="form-control no-arabic numbers-only factor"
                                                           name="cost_fees[]" value="0.00"  required>
                                                </td>
                                                <td>
