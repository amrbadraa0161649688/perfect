        ...
        <div class="section-body mt-3" id="app">
            <div class="container-fluid">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="selectpicker"  data-live-search="true"
                                            name="item_id">
                                        @foreach($item_lits as $item_lit)
                                            <option value="{{ $item_lit->item_code }}"
                                            >  
                                               @if(app()->getLocale()=='ar') 
                                               {{$item_lit->item_code}}\\ {{$item_lit->branch_id}} \\ {{$item_lit->item_name_a}} 
                                               @else
                                               {{$item_lit->item_code}}\\ {{$item_lit->branch_id}} \\ {{$item_lit->item_name_e}} 
                                            @endif
                                        </option>
                                        @endforeach
                                    </select>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select class="form-control"
                                            ...
                                            @foreach($cars_list as $car_list)
                                                <option value="{{ $car_list->mntns_cars_vat_no}}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                            <button class="btn btn-primary mt-4" type="submit"><i
                                                        class="fa fa-search fa-fw"></i>@lang('home.search')
                                            </button>
                ...
                <div class="card-footer row">
                            ...
                            <a href="{{config('app.telerik_server')}}?rpt={{$report_url_ins_rs->report_url}}&branch_id={{implode(',',request()->input('branchs_id',[]))}}&store_id={{implode(',',request()->input('stores_id',[]))}}&report_type=62003&date_from={{request()->created_date_from}}&date_to={{request()->created_date_to}}&cus_id={{implode(',',request()->input('customers_ids',[]))}}&pay_id={{implode(',',request()->input('bond_type_id',[]))}}&lang=ar&skinName=bootstrap"
                            ...
                            <div class="col-sm-6 col-xs-6 col-md-6 col-lg-6">
                                <a href="{{config('app.telerik_server')}}?rpt={{$report_url_inv_rs->report_url}}&branch_id={{implode(',',request()->input('branchs_id',[]))}}&store_id={{implode(',',request()->input('stores_id',[]))}}&report_type=62006&date_from={{request()->created_date_from}}&date_to={{request()->created_date_to}}&cus_id={{implode(',',request()->input('customers_ids',[]))}}&pay_id={{implode(',',request()->input('bond_type_id',[]))}}&lang=ar&skinName=bootstrap"
                                                class="btn btn-warning btn-block" id='showReport'  target="_blank" 
                                               >@lang('home.print')</a>
                            </div>
                            @endforeach
                            ...
                            @foreach($report_url_ins as $report_url_ins_rs)  
                            <div class="col-sm-6 col-xs-6 col-md-6 col-lg-6">
                            <a href="{{config('app.telerik_server')}}?rpt={{$report_url_ins_rs->report_url}}&branch_id={{implode(',',request()->input('branchs_id',[]))}}&store_id={{implode(',',request()->input('stores_id',[]))}}&report_type=62004&date_from={{request()->created_date_from}}&date_to={{request()->created_date_to}}&cus_id={{implode(',',request()->input('customers_ids',[]))}}&pay_id={{implode(',',request()->input('bond_type_id',[]))}}&lang=ar&skinName=bootstrap"
                                                class="btn btn-warning btn-block" id='showReport'  target="_blank" 
                                                >@lang('home.print')</a>
                            </div>
                            @endforeach 
                            ...
                            @foreach($report_url_inv as $report_url_inv_rs) 
                            <div class="col-sm-6 col-xs-6 col-md-6 col-lg-6">
                                <a href="{{config('app.telerik_server')}}?rpt={{$report_url_inv_rs->report_url}}&branch_id={{implode(',',request()->input('branchs_id',[]))}}&store_id={{implode(',',request()->input('stores_id',[]))}}&report_type=62007&date_from={{request()->created_date_from}}&date_to={{request()->created_date_to}}&cus_id={{implode(',',request()->input('customers_ids',[]))}}&pay_id={{implode(',',request()->input('bond_type_id',[]))}}&lang=ar&skinName=bootstrap"
                                                class="btn btn-warning btn-block" id='showReport'  target="_blank" 
                                               >@lang('home.print')</a>
                            </div>
                            @endforeach
                            ...
                            <div class="col-sm-6 col-xs-6 col-md-6 col-lg-6">
                                <a href="{{config('app.telerik_server')}}?rpt={{$report_url_item_rs->report_url}}&branch_id={{implode(',',request()->input('branchs_id',[]))}}&store_id={{implode(',',request()->input('stores_id',[]))}}&date_from={{request()->created_date_from}}&date_to={{request()->created_date_to}}&item_id={{request()->item_id}}&lang=ar&skinName=bootstrap"
                                                class="btn btn-warning btn-block" id='showReport'  target="_blank" 
                                               >@lang('home.print')</a>
                            </div>
                            @endforeach
                            ...
                            <div class="col-sm-6 col-xs-6 col-md-6 col-lg-6">
                                <a href="{{config('app.telerik_server')}}?rpt={{$report_url_items_rs->report_url}}&branch_id={{implode(',',request()->input('branchs_id',[]))}}&store_id={{implode(',',request()->input('stores_id',[]))}}&report_type=62007&date_from={{request()->created_date_from}}&date_to={{request()->created_date_to}}&lang=ar&skinName=bootstrap"
                                                class="btn btn-warning btn-block" id='showReport'  target="_blank" 
                                               >@lang('home.print')</a>
                            </div>
                            @endforeach
                            ...
                            {{--تقرير   ربحيه الاصناف  --}}
                            @if ( request()->report_id == 103007)
                            @foreach($report_url_items_sales as $report_url_items_sales_rs)
                            <div class="col-sm-6 col-xs-6 col-md-6 col-lg-6">
                                <a href="{{config('app.telerik_server')}}?rpt={{$report_url_items_sales_rs->report_url}}&branch_id={{implode(',',request()->input('branchs_id',[]))}}&store_id={{request()->store_id}}&report_type=62007&date_from={{request()->created_date_from}}&date_to={{request()->created_date_to}}&cus_id={{implode(',',request()->input('customers_ids',[]))}}&lang=ar&skinName=bootstrap"
                                                class="btn btn-warning btn-block" id='showReport'  target="_blank"
                                               >@lang('home.print')</a>
                            </div>
                            @endforeach
                            ...
                            {{--تقرير   كارت السياره  --}} 
                            @if ( request()->report_id == 103008) 
                            @foreach($report_url_cars as $report_url_cars_rs) 
                            <div class="col-sm-6 col-xs-6 col-md-6 col-lg-6">
                            <a href="{{config('app.telerik_server')}}?rpt={{$report_url_cars_rs->report_url}}&branch_id={{implode(',',request()->input('branchs_id',[]))}}&store_id={{implode(',',request()->input('stores_id',[]))}}&date_from={{request()->created_date_from}}&date_to={{request()->created_date_to}}&item_id={{request()->mntns_cars_id}}&lang=ar&skinName=bootstrap"
                                                class="btn btn-warning btn-block" id='showReport'  target="_blank" 
                                               >@lang('home.print')</a>
                            </div>
                            @endforeach
