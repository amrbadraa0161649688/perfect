                                ...
                                <table class="table mb-0">
                                    ...
                                    @foreach($bond->bond_details as $bond_detail)
                                        <tr>
                                            ...
                                            $bond_detail->bondDocType->system_code_name_en }}
                                            </td>
                                            <td>
                                                {{ app()->getLocale() == 'ar' ?
                                            ...
                                            <td>{{$bond_detail->bond_amount_credit - $bond_detail->bond_vat_amount}}</td>
                                            <td>{{$bond_detail->bond_vat_rate}}</td>
                                            <td>{{$bond_detail->bond_vat_amount}}</td>
                                            <td>{{$bond_detail->bond_amount_credit}}</td>
                                        </tr>
                                    @endforeach
                                    </tbody>
                                </table>
