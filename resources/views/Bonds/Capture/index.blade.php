        ...
        <div class="container-fluid">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select class="selectpicker" multiple data-live-search="true"
                                                @if($flag==0) disabled @else required @endif
                                                name="company_id[]">
                                            ...
                                            @foreach($companies as $company)
                                                @foreach($company->branches as $branch)
                                                    <option
                                                            ...
                                                            @endif @endif
                                                            @if(request()->branch_ids) @foreach(request()->branch_ids as
            ...
            <div class="row mb-12">
                        ...
                        @foreach(session('job')->permissions as $job_permission)
                            @if($job_permission->app_menu_id == 53 && $job_permission->permission_add)
                                <button type="button" class="btn btn-primary" data-toggle="modal"
                                    ...
                                    <a href="{{ route('Bonds-capture.create') }}" class="btn btn-primary">
                ...
                <div class="col-6 col-md-3 d-flex justify-content-end">
                    <form action="{{route('Bonds-capture.export') }}">
                                                ...
                                                @if(auth()->user()->user_type_id != 1)
                                                    @foreach(session('job')->permissions as $job_permission)
                                                        @if($job_permission->app_menu_id == 53 && $job_permission->permission_update)
                                                            <a href="{{ route('Bonds-capture.edit',$bond->bond_id) }}"
                                                               class="btn btn-danger btn-sm" title="show">
