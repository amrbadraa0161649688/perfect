        ...
        <div class="container-fluid">
            <div class="tab-content mt-3">
                ...
                <div class="tab-pane fade show active " id="data-grid" role="tabpanel">
                    ...
                    <form class="card" id="validate-form" action="{{ route('store-client.store') }}"
                          method="post"
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                                    ...
                                                    <select class="form-select form-control" name="customer_account_id"
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" class="form-control is-invalid" name="customer_vat_no"
                                               id="customer_vat_no" v-model="customer_vat_no"  placeholder="@lang('customer.vat_no')" required>
                                    </div>
                            ...
                            <div class="mb-3">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <label for="recipient-name"
                                                class="col-form-label"> @lang('customer.addition_per') </label>
                                        <input type="text" class="form-control " name="addition_per" v-model="addition_per"
                                                id="addition_per" placeholder="@lang('customer.addition_per')"
                                                >
                                    </div>
                                    <div class="col-md-4">
                                        <label for="recipient-name"
                                                class="col-form-label"> @lang('customer.discount_per') </label>
                                        <input type="text" class="form-control "
                                                name="discount_per" v-model="discount_per"
                                                id="discount_per"
                                                placeholder="@lang('customer.discount_per')"
                                               >
                                    </div>
                                    <div class="col-md-4">
                                        <label for="recipient-name"
                                                class="col-form-label"> @lang('customer.vat_per') </label>
                                        <input type="text" class="form-control " name="vat_per" v-model="vat_per"
                                                id="vat_per" placeholder="@lang('customer.vat_per')"
                                                >
                                    </div>
                                </div>
                            </div>
...
@endsection
    ...
    $(document).ready(function () {
        ...
        $('#addition_per').keyup(function () {
            if ($('#addition_per').val() == "") {
                $('#addition_per').addClass('is-invalid')
                $('#create_emp').attr('disabled', 'disabled')
            } else {
                $('#addition_per').removeClass('is-invalid')
                $('#create_emp').removeAttr('disabled', 'disabled')
            }
        });
        ...
        $('#discount_per').keyup(function () {
            if ($('#discount_per').val() == "") {
                $('#discount_per').addClass('is-invalid')
                $('#create_emp').attr('disabled', 'disabled')
            } else {
                $('#discount_per').removeClass('is-invalid')
                $('#create_emp').removeAttr('disabled', 'disabled')
            }
        });

        $('#vat_per').keyup(function () {
            if ($('#vat_per').val() =="") {
                $('#vat_per').addClass('is-invalid')
                $('#create_emp').attr('disabled', 'disabled')
            } else {
                $('#vat_per').removeClass('is-invalid')
                $('#create_emp').removeAttr('disabled', 'disabled')
            }
        });
