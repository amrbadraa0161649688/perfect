        ...
        <tbody >
            ...
            @foreach($purchase_request->details as $key => $d)
                ...
                <tr id="{{ $d->uuid }}">
                    ...
                    <td class="ctd"> {{ (number_format($d->store_vou_qnt_t_o) - number_format($d->store_vou_qnt_t_i_r) )}} </td>
                    <td class="ctd"> 
                        <input type="text" class="form-control item-qty" name="{{$d->uuid}}" id="store_vou_qnt_i_{{$d->uuid}}" value="{{ (number_format($d->store_vou_qnt_t_o) - number_format($d->store_vou_qnt_t_i_r) )}}" onchange="calculateItem(this)" readonly>
                        <input type="hidden" class="form-control" name="{{$d->uuid}}" id="store_vou_qnt_p_{{$d->uuid}}" value="{{ (number_format($d->store_vou_qnt_t_o) - number_format($d->store_vou_qnt_t_i_r) )}}" readonly>
                    </td>
                    <td class="ctd"> 
                        <input type="text" class="form-control" name="store_vou_qnt_t_i_r" id="store_vou_qnt_t_i_r_{{$d->uuid}}" value="{{ (number_format($d->store_vou_qnt_t_o) - number_format($d->store_vou_qnt_t_i_r) )}}" readonly>
                    </td>
                    <td class="ctd"> 
