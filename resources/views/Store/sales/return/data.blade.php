        ...
        <div class="card">
                        ...
                        @if($job_permission->app_menu_id == 94 && $job_permission->permission_add)
                            <div class="header-action">
                                <button type="button" class="btn btn-primary" data-toggle="modal"
                                        data-target="#create_return_modal">
                                    <i class="fe fe-plus mr-2"></i> @lang('sales.add_return_button')
                                </button>
                            </div>
                        @endif
                    @endforeach
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-striped return_table">
                        <thead  class="thead-light">
                        <tr>
                            <th>No</th>
                            <th> @lang('sales.branch') </th>
                            <th> @lang('sales.warehouse_type') </th>
                            <th> @lang('sales.return_no') </th>
...
@include('store.sales.return.create_return')
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        url = "{{ route('store-sales-return.data.table', ':id') }}";
