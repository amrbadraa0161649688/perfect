                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control" name="store_acc_name" id="store_acc_name" value="{{$purchase->store_acc_name}}" disabled>
                                        </div>
                                        <div class="col-md-4">
                                            <label for="recipient-name" class="col-form-label "> @lang('purchase.vat_no') </label>
                                            <input type="number" class="form-control" name="store_acc_tax_no" id="store_acc_tax_no" value="{{$purchase->store_acc_tax_no}}" disabled>
                                        </div>
                                        <div class="col-md-4">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                           <label for="recipient-name" class="col-form-label">@lang('purchase.note') </label>
                                            <textarea rows="2" class="form-control" name="store_vou_notes" id="store_vou_notes" placeholder="Here can be your note" value="" disabled> {{$purchase->tore_vou_notes }}</textarea>
                                        </div>
                                        <div class="col-md-4">
                                            <br>
                                            <br>
                        ...
                        <div class="col-md-12">
                            <div class="mb-3"> 
                                ...
                                <div class="table-responsive">
                                    @include('store.purchase.order.table.direct_item_table')
                                </div>
                            </div>
                        </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#store_vou_qnt_p').change(function()  {
                ...
                $('#store_vou_item_total_price').val(getNum($('#store_vou_qnt_p').val() * $('#store_vou_item_price_unit').val()));
        ...
        function saveItemRow()
        {
            ...
            row_data = {
                ...
                'store_vou_qnt_p' : getNum($('#store_vou_qnt_p').val()),
            ...
            url = '{{ route('store-item-purchase-direct-order.store') }}';
