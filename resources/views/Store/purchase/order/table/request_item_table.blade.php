    ...
    <table class="table table-bordered card_table" id="item_table">
        <tbody >
            <tr>
                ...
                <th class="ctd table-active" style="width:7%">كمية امر الشراء</th>
            ...
            @foreach($purchase_request->details as $key => $d)
                <?php  
                    ...
                    $qty = number_format($d->store_vou_qnt_r) - number_format($d->store_vou_qnt_t_i_r);
                ...
                <tr id="{{ $d->uuid }}">
                    ...
                    <td class="ctd"> 
                        <input type="text" class="form-control item-qty" name="{{$d->uuid}}" id="store_vou_qnt_p_{{$d->uuid}}" value="{{ (number_format($d->store_vou_qnt_r) - number_format($d->store_vou_qnt_t_i_r) )}}" onchange="calculateItem(this)" readonly>
            ...
            <input type="hidden" class="form-control" name="store_vou_ref_before" id="store_vou_ref_before" value="{{ $d->purchase->uuid }}" >
        </tbody>
        <tfoot>
            <tr>
