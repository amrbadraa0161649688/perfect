...
<table class="table table-bordered card_table" id="item_table">
        ...
        @foreach($purchase_request->details as $key => $d)
            ...
            $qty = $d->store_vou_qnt_i - $d->store_vou_qnt_t_i_r;
            ...
            <!-- <td class="ctd"> {{ $key + 1 }} </td> -->
                ...
                <td class="ctd"> {{ $d->store_vou_qnt_i - $d->store_vou_qnt_t_i_r}} </td>
                <td class="ctd">
                    <input type="text" class="form-control item-qty" name="{{$d->uuid}}"
                           id="store_vou_qnt_i_r_{{$d->uuid}}"
                           value="{{ $d->store_vou_qnt_i - $d->store_vou_qnt_t_i_r}}"
                           onchange="calculateItem(this)" readonly>
                    <input type="hidden" class="form-control" name="{{$d->uuid}}" id="store_vou_qnt_i_{{$d->uuid}}"
                           value="{{ $d->store_vou_qnt_i - $d->store_vou_qnt_t_i_r}}"
                           readonly>
                </td>
                <td class="ctd">
