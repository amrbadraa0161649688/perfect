                        ...
                        @if($job_permission->app_menu_id == 66 && $job_permission->permission_add)
                            <div class="header-action">
                                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#create_return_modal">
                                    <i class="fe fe-plus mr-2"></i>  @lang('purchase.add_return_button')
                                </button>
                            </div>
                        @endif
                    @endforeach
...
@include('store.purchase.return.create_return') 
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        url = "{{ route('store-purchase-return.data.table', ':id') }}";
