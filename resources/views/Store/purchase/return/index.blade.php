...
@section('scripts')
    ...
    <script type="text/javascript">
        ...
        function getData(){
            ...
            $.ajax({
                type: 'get',
                url :"{{route('store-purchase-return.data','return')}}",
                data:{
                    _token : "{{ csrf_token() }}",
        ...
        {
            $('#create_return_modal').on('hidden.bs.modal', function () {
                //$('#create_return_modal .modal-body').html('');
            });
            $('#create_return_modal').modal('hide');
        }
