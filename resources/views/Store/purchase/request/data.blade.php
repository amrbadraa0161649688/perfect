        ...
        <div class="card">
            ...
            <div class="col-md-12">
                <div class="header-action">
                    @foreach(session('job')->permissions as $job_permission)
                        @if($job_permission->app_menu_id == 62 && $job_permission->permission_add)
                            <div class="header-action">
                                <button type="button" class="btn btn-primary" data-toggle="modal"
                                        data-target="#create_request_modal">
                                    <i class="fe fe-plus mr-2"></i> @lang('purchase.add_request_button')
                                </button>

                                <a href="{{route('stations-storePurchaseRequest.create')}}" class="btn btn-primary">
                                    <i class="fe fe-plus mr-2"></i> @lang('purchase.add_request_button_stations')
                                </a>
                            </div>
                        @endif
                    @endforeach
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-striped request_table">
                        <thead class="thead-light">
                        <tr>
                            <th>No</th>
                            <th> @lang('purchase.branch') </th>
                            <th> @lang('purchase.request_no') </th>
                            ...
                            <th> @lang('purchase.request_status') </th>
...
@include('store.purchase.request.create_request')
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        url = "{{ route('store-purchase-request.data.table', ':id') }}";
