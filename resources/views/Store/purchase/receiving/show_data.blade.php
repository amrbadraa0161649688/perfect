    ...
    <div class="row" id="new">
        ...
        <div class="col-md-3">
            ...
            <select class="form-select form-control" name="store_vou_pay_type" id="store_vou_pay_type" disabled>
                ...
                <option value="{{$p_method->system_code}}" {{($purchase_request->store_vou_pay_type == $p_method->system_code? 'selected': '' )}}> {{ $p_method->getSysCodeName() }} </option>
                @endforeach
            </select>
        </div>
        <div class="col-md-9">
        ...
        <div class="col-md-12">
            <div class="mb-3"> 
                <div class="table-responsive">
                    @include('store.purchase.receiving.table.order_item_table')  
                </div>
            </div>
        </div>
