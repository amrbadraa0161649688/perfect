    ...
    <div class="section-body mt-3" id="app">
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-3">
                    <form action="">
                        <select class="form-control" id="company_id" name="company_id"
                                onchange="getData( $('#company_id').val())" disabled>
                ...
                <div class="col-md-3">
                    <form action="">
                        <select class="form-control" id="warehouses_type" name="warehouses_type"
                                onchange="getData( $('#company_id').val())">
                            <option value="">@lang('home.choose')</option>
...
@section('scripts')
    ...
    <script type="text/javascript">
        ...
        function getData() {
            ...
            $.ajax({
                type: 'get',
                url: "{{route('store-purchase-receiving.data','receiving')}}",
                data: {
                    _token: "{{ csrf_token() }}",
        ...
        function closeItemModal() {
            $('#create_receive_modal').on('hidden.bs.modal', function () {
                //$('#create_receive_modal .modal-body').html('');
            });
            $('#create_receive_modal').modal('hide');
        }
