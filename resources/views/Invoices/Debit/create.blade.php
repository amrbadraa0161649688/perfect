                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="font-25" bold>
                                        @lang('invoice.add_new_debit')
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('Invoices-debit.store') }}" method="post">
                                @csrf
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    <label class="form-label">@lang('invoice.invoice_date')</label>
                                        ...
                                        <div class="mb-3">
                                           ...
                                           <div class="row">
                                                     ...
                                                     <label for="recipient-name"
                                                        ...
                                                        <input type="text" class="form-control "
                                                               name="payment_tems"
                                                               id="payment_tems" :value="payment_tems"
