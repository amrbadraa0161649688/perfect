                            ...
                            <div class="card-body">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-md-3">
                                            <button class="btn btn-primary mt-2  mt-md-4 w-100" type="submit"><i
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            @foreach($compani as $companys)
                                                <a href="{{config('app.telerik_server')}}?rpt={{$companys->report_url_all->report_url}}&id={{$companys->company_id}}&invoice_from={{request()->due_date_from}}&invoice_to={{request()->due_date_to}}&lang=ar&skinName=bootstrap"
                                                   class="btn btn-primary mt-2 mt-md-4 w-100" target="_blank"
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            title="{{trans('PRINT')}}" class="btn btn-primary mt-2 mt-md-4 w-100"   id="showReport" target="_blank">
                            ...
                            @if(auth()->user()->user_type_id != 1)
                                @foreach(session('job')->permissions as $job_permission)
                                    @if($job_permission->app_menu_id == 106 && $job_permission->permission_add)
                                        <a href="{{route('Invoices-acc.create')}}" class="btn btn-primary">
