                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h2 class="text-muted mb-4 text-center">@lang('invoice.invoice_return')</h2>
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                ...
                                <div class="row">
                                 ...
                                 <div>
                                    @if ($invoice->company->company_id == 29)
                                    <a
                                    href="{{config('app.telerik_server')}}?rpt=waqoodi/invoice_return_hd&id={{$invoice->invoice_id}}&lang=ar&skinName=highcontrast"
                                    title="{{trans('Print')}}" class="btn btn-circle btn-default red-flamingo" id="showReport" target="_blank">
                                    {{trans('Print')}}
                                    </a>
                                    @else
                                    <a
                                    href="{{config('app.telerik_server')}}?rpt=perfect/invoice_return_hd&id={{$invoice->invoice_id}}&lang=ar&skinName=highcontrast"
                                    title="{{trans('Print')}}" class="btn btn-circle btn-default red-flamingo" id="showReport" target="_blank">
                                    {{trans('Print')}}
                                    </a>
                                    @endif
