                                ...
                                @foreach($invoices as $k=>$invoice)
                                    <tr>
                                        ...
                                        <td colspan="2">
                                            ...
                                            @else
                                                <a href="{{config('app.telerik_server')}}?rpt={{$invoice->report_url->report_url}}&id={{$invoice->invoice_id}}&lang=ar&skinName=bootstrap"
                                                   title="{{trans('Print')}}" class="btn btn-primary btn-sm"
                                                   id="showReport" target="_blank">
                                                    {{trans('Print')}}
                                                </a>
