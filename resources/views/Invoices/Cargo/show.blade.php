                            ...
                            <div class="table-responsive">
                                <table class="table text-nowrap mb-0">
                                    ...
                                    @foreach($invoice->invoiceDetails as $k=>$invoice_detail)
                                        <tr>
                                            <td>{{ $k+1 }}</td>
                                            <td>{{ $invoice_detail->invoice_reference_no }}</td>
                                ...
                                <div class="row">
                                 ...
                                 <div>
                                    <a
                                    href="{{config('app.telerik_server')}}?rpt={{$invoice->report_url_cargo_smal->report_url}}&id={{$invoice->invoice_id}}&lang=ar&skinName=bootstrap"
                                 ...
                                 <div>
                                    ...
                                    title="{{trans('Print-Details')}}" class="btn btn-circle btn-default red-flamingo" id="showReport" target="_blank">
                                    {{trans('Print-Detail')}}
                                 </a>
                                 </div>
