                                                                ...
                                                                <div class="row">
                                                                                ...
                                                                                <div class="col-md-3">
                                                                                    <div class="col-3 col-md-3 col-lg-3">
                                                                                            ...
                                                                                            <img class="w50 mr-2" src="{{ asset('assets/images/95.png') }}" >
                                                                ...
                                                                <tr id="invoice_item_id" class="clone"  v-for="(invoice,index) in invoices">
                                                                    ...
                                                                    <td>
                                                                        <input hidden type="text"
                                                                            ...
                                                                            <input type="decimal"
                                                                            name="invoice_total_amount_N[]"
                                                                            v-model="invoices[index]['invoice_total_amount_N']"

                                                                            @keyup="getQUNT(index)" @change="getQUNT(index),getTotals(index)" autocomplete="off"
    ...
    <script>
        ...
        new Vue({
            ...
            methods: {
                addRow() {
                    this.invoices.push({
                        'invoice_item_id': '70002', 'invoice_item_price': 0.000, 'invoice_item_quantity': 0,
