                                                                ...
                                                                <div class="row">
                                                                                ...
                                                                                <div class="col-md-6">
                                                                                    <div class="col-3 col-md-3 col-lg-3">
                                                                                            ...
                                                                                            <img class="w50 mr-2" src="{{ asset('assets/images/91.png') }}" >
                                                        ...
                                                        <table  class="table table-bordered table-condensed" id="add_table">
                                                            <thead class="thead-light">
                                                                <tr>
                                                                    ...
                                                                    <th hidden  style="font-size: 16px ;font-weight: bold;width: 100px "
                                                                ...
                                                                <tr id="invoice_item_id" class="clone"  v-for="(invoice,index) in invoices">
                                                                    ...
                                                                    <td >
                                                                        <input type="decimal"
                                                                            ...
                                                                            class="form-control decimal  no-arabic is-invalid numbers-only" step="0.0001" autocomplete="off"
    ...
    <script>
        ...
        new Vue({
            ...
            methods: {
                addRow() {
                    this.invoices.push({
                        'invoice_item_id': '70001', 'invoice_item_price': 0.000, 'invoice_item_quantity': 0,
