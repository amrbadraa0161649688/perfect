                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-lg-3">
                                            <div class="card-body" style="">
                                                ...
                                                @else
                                                    <p>@lang('home.qr_code_not_added')</p>
                                                @endif
                                            </div>
                                        </div>
                            ...
                            <div>
                                <a
                                        href="{{config('app.telerik_server')}}?rpt={{$invoice->report_url_car_10->report_url}}&id={{$invoice->invoice_id}}&lang=ar&skinName=bootstrap"
                                        title="{trans('Print')}" class="btn btn-primary btn-sm" id="showReport"
                                        target="_blank">
                                    {{trans('Print - details')}}
                                </a>

                                <a
                                        href="{{config('app.telerik_server')}}?rpt={{$invoice->report_url_car_11->report_url}}&id={{$invoice->invoice_id}}&lang=ar&skinName=bootstrap"
                                        title="{trans('Print')}" class="btn btn-primary btn-sm" id="showReport"
                                        target="_blank">
                                    {{trans('Print - total')}}
                                </a>
                                ...
                                <a
                                        href="{{config('app.telerik_server')}}?rpt={{$invoice->report_url_car_12->report_url}}&id={{$invoice->invoice_id}}&lang=ar&skinName=bootstrap"
                                        title="{trans('Print')}" class="btn btn-primary btn-sm" id="showReport"
                                        target="_blank">
                                    {{trans('Print - Ref')}}
                                </a>
                                <a
                                        href="{{config('app.telerik_server')}}?rpt={{$invoice->report_url_car_13->report_url}}&id={{$invoice->invoice_id}}&lang=ar&skinName=bootstrap"
                                        title="{trans('Print')}" class="btn btn-primary btn-sm" id="showReport"
                                        target="_blank">
                                    {{trans(' invoice')}}
                                </a>
