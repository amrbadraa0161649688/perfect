                    ...
                    <div class="row mb-12">
                        <div class="col-md-3">
                            ...
                            @if(auth()->user()->user_type_id != 1)
                                @foreach(session('job')->permissions as $job_permission)
                                    @if($job_permission->app_menu_id == 119 && $job_permission->permission_add)
                                        <a href="{{route('Invoices.cars.create')}}" class="btn btn-primary">
                        ...
                        <div class="col-md-2">
                            <form action="{{route('invoices-export') }}">
                                ...
                                <button href="{{ route('invoices-export') }}" type="submit"
                            ...
                            <table class="table table-hover table-vcenter table_custom text-nowrap spacing5 text-nowrap mb-0"
                                ...
                                @foreach($invoices as $k=>$invoice)
                                    <tr>
                                        ...
                                        <td><a href="{{ route('invoices.Cars.show',$invoice->invoice_id) }}"
                                     ...
                                     $invoice->customer->customer_name_full_en }}</td>
                                        ...
                                        <td style="font: bold">{{number_format($invoice->invoice_amount - $invoice->invoice_total_payment,2 )}}</td>
                                        ...
                                        <td colspan="2">
                                            @if($invoice->journalHd || $invoice->invoicestatus->system_code==121003)
                                                <a href="{{ route('Invoices.cars.edit',$invoice->invoice_id) }}"
                                                   class="btn btn-primary btn-sm"
