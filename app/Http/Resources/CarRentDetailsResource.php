...
class CarRentDetailsResource extends JsonResource
{
    /**
...
//        return $price_list_dt;
        ...
        $price_list_hd = isset($this->model->priceListDts->first()->priceListHd) ? $this->model->priceListDts->first()->priceListHd : null;
        return [
            'car_id' => $this->car_id,
...
//            'full_fuel_cost' => $this->fullFuelCost,
            ...
            'price_list_id' => $price_list_hd ? $price_list_hd->rent_list_id : null,
